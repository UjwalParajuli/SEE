...
public class ForgotPasswordActivity extends AppCompatActivity {
    EditText edit_text_email_2, edit_text_password_2;
    Button button_change_password;
    ProgressBar progress_bar_forgot_password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_bar_forgot_password = (ProgressBar) findViewById(R.id.progress_bar_forgot_password);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    if (response.trim().equals("success")){
                        progress_bar_forgot_password.setVisibility(View.GONE);
