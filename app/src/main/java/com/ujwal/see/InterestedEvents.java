...
public class InterestedEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Interested Events");

        recyclerView = (RecyclerView)findViewById(R.id.rc_view_interested_events);
        eventModelArrayList = new ArrayList<>();
        eventAdapter = new EventAdapter(eventModelArrayList, InterestedEvents.this);
        progress_bar = (ProgressBar)findViewById(R.id.progress_bar_interested_events);
        text_view = (TextView)findViewById(R.id.text_view_interested_events);
    ...
    public void getInterestedEvents(){
        String url = "https://ujwalparajuli.000webhostapp.com/android/getInterestedEvents.php";
        progress_bar.setVisibility(View.VISIBLE);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE,WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
        final RequestQueue requestQueue = Volley.newRequestQueue(InterestedEvents.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.trim().equals("error")) {
                    Toast.makeText(InterestedEvents.this, "No Data", Toast.LENGTH_SHORT).show();
                }
                else {
                    try {
                        ...
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(InterestedEvents.this, RecyclerView.VERTICAL, false);
...
//                        });
                        ...
                        Toast.makeText(InterestedEvents.this, e.toString(), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NetworkError) {
                    //progress_bar.setVisibility(View.GONE);
                    //getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    Toast.makeText(InterestedEvents.this,"Cannot connect to Internet...Please check your connection!",Toast.LENGTH_SHORT).show();
                } else if (error instanceof ServerError) {
                    //progress_bar.setVisibility(View.GONE);
                    //getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    Toast.makeText(InterestedEvents.this,"The server could not be found. Please try again after some time!!",Toast.LENGTH_SHORT).show();
                    ...
                    //progressBarHome.setVisibility(View.GONE);
                    //getActivity().getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    Toast.makeText(InterestedEvents.this,"Parsing error! Please try again after some time!!",Toast.LENGTH_SHORT).show();
                    ...
                    //progressBarHome.setVisibility(View.GONE);
                    //getActivity().getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    Toast.makeText(InterestedEvents.this,"Connection TimeOut! Please check your internet connection.",Toast.LENGTH_SHORT).show();
                }
            }
        }) {
            @Override
